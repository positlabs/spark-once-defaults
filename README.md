## Triggering Once and Assigning Defaults in Spark AR

Learn how to trigger something once in the patch editor, and use that behavior to determine default values for user inputs.
